    ...
    <>
      ...
      <div className="container grid grid-cols-2 lg:grid-cols-8 lg:gap-10 h-full mt-14 mb-0">
        <div className="col-span-6">
          <div className="bg-white mb-12 border-2 rounded-sm border border-[#E6E6E6] cursor-pointer">
            ...
            <div className="p-3 sm:p-9 pb-0">
              ...
              <p className="text-base font-normal text-gray text-justify text-xl w-100">
