...
export default function QuienesSomos() {
  ...
  return (
    <div>
      ...
      />
      <MisionVision imageMision={`${API_URL}${data?.Mision_Imagen?.data?.attributes?.url}`} imageVision={`${API_URL}${data?.Vision_Imagen?.data?.attributes?.url}`} imageObjetivos={`${API_URL}${data?.Objetivos_Imagen.data?.attributes?.url}`} title={data?.Titulo_QuienesSomos_Pagina_Quienes_Somos} description={data?.Quienes_Somos} objetivos={data?.Objetivos} vision={data?.Vision} mision={data?.Mision} />
      <IdentidadCorporativaOrganizativa titleIdentidadOrganizativa={data?.Identidad_Organizativa_Titulo} imageIdentidadOrganizativa={`${API_URL}${data?.Identidad_Organizativa_Imagen.data?.attributes?.url}`}  titleIdentidadCorporativa={data?.Identidad_Corporativa_Titulo} imageIdentidadCorporativa={`${API_URL}${data?.Imagen_Identidad_Corporativa.data?.attributes?.url}`} />
    </div>
  );
}
