  ...
  return (
    <div className="container py-10 md:py-20 px-3 sm:px-0">
      <div className="lg:grid sm:grid-flow-col gap-10">
        <div className="box-shadow-category sm:row-span-3 items-center rounded-3xl  break-all grid duration-500 border-2 border-[#A7A6A6] cursor-pointer hover:duration-500">
          <Link href={`${categoriesProjects && categoriesProjects[0] && categoriesProjects[0]?.attributes?.Enlace}`}>
            <div className="px-8 py-8 lg:py-0">
              <img
                ...
                src={`${API_URL}${categoriesProjects && categoriesProjects[0] && categoriesProjects[0]?.attributes?.Imagen_de_Categoria?.data?.attributes?.url}`}
              />
        ...
        <div>
          <div className="sm:grid sm:grid-columns-2 grid-flow-col gap-10">
            <div className="box-shadow-category  break-all hover:duration-500 bg-white rounded-3xl duration-500 border-2 border-[#A7A6A6] cursor-pointer">
              <Link href={`${categoriesProjects && categoriesProjects[1] && categoriesProjects[1]?.attributes?.Enlace}`}>
                <div className="px-8 py-8">
                  <img
                    alt="image"
                    className="w-24 m-auto"
                    src={`${API_URL}${categoriesProjects && categoriesProjects[1] && categoriesProjects[1]?.attributes?.Imagen_de_Categoria?.data?.attributes?.url}`}
                  />
                  <h3 className="text-xl font-bold text-purpledark w-full m-auto text-center mt-4">
            ...
            <div className="bg-white rounded-3xl  break-all duration-500 box-shadow-category hover:duration-500 border-2 border-[#A7A6A6] cursor-pointer">
              <Link href={`${categoriesProjects && categoriesProjects[2] && categoriesProjects[2]?.attributes?.Enlace}`}>
                <div className="px-8 py-8">
                  <img
                    alt="image"
                    className="w-24 m-auto"
                    src={`${API_URL}${categoriesProjects && categoriesProjects[2] && categoriesProjects[2]?.attributes?.Imagen_de_Categoria?.data?.attributes?.url}`}
                  />
                  <h3 className="text-xl font-bold text-purpledark w-full m-auto text-center mt-4">
        ...
        <div className="row-span-1  mt-5 lg:mt-0  break-all items-center bg-white rounded-3xl duration-500 box-shadow-category  hover:duration-500   border-2 border-[#A7A6A6] cursor-pointer">
          <Link href={`${categoriesProjects && categoriesProjects[3] && categoriesProjects[3]?.attributes?.Enlace}`}>
            <div className="px-8 py-8">
              <img
                alt="image"
                className="w-24 m-auto"
                src={`${API_URL}${categoriesProjects && categoriesProjects[3] && categoriesProjects[3]?.attributes?.Imagen_de_Categoria?.data?.attributes?.url}`}
              />
              <h3 className="text-xl font-bold text-purpledark w-full m-auto text-center mt-4">
                ...
                <Link href={`${categoriesProjects && categoriesProjects[index] && categoriesProjects[index]?.attributes?.Enlace}`}>
                  <div className="px-8 py-8">
                    <img
                      alt="image"
                      className="w-24 m-auto"
                      src={`${API_URL}${categoriesProjects && categoriesProjects[index] && categoriesProjects[index]?.attributes?.Imagen_de_Categoria?.data?.attributes?.url}`}
                    />
                    <h3 className="text-xl font-bold text-purpledark w-full m-auto text-center mt-4">
