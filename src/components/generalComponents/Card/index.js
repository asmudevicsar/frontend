  ...
  return (
    <div className="bg-white mb-8 rounded-sm duration-500 hover:drop-shadow-xl hover:duration-500 border border-[#E6E6E6] cursor-pointer">
      ...
      <div className="p-3 pb-0">
        ...
        <p className="text-base font-normal text-[#606060] w-4/5 text-description-eventnotice m-auto text-center text-xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
