  ...
  return (
    <div>
      ...
      <div className="text-center">
        <button className="mt-6 mb-2 sm:mt-10 sm:mb-8 bg-purpledark drop-shadow-lg h-9 px-8 rounded text-white text-sm duration-500 hover:bg-purplelight hover:duration-500 ">Ver más noticias</button>
      </div>
    </div>
  );
}
