...
export default function CategoriesProject() {
  ...
  return (
    <div className={`container categoriasproyectos w-full grid-container grid grid-cols-2 sm:grid-cols-${categoriesProjects?.length}  divide-x p-4 divide-[#E8E8E8] m-5 sm:m-14`}>
