  ...
  return (
    <>
      <nav className="w-full mx-auto border-b-2 border-b-purplelight z-50 fixed bg-[#fff]">
        <nav className="navbar-responsive bg-white">
          <div className="navbar-container border-b-2 border-b-purplelight">
            <input type="checkbox" name="" id="" className="flex justify-end" />
            <div className="hamburger-lines flex justify-end">
              <span className="line line1 bg-purpledark"></span>
              <span className="line line2 bg-purpledark"></span>
              <span className="line line3 bg-purpledark"></span>
            </div>
      ...
      <button className="btn-general-whatsapp bg-purpledark duration-500 fixed z-50 top-2/3 sm:top-1/3 p-2 rounded-full right-1 sm:right-6 hover:bg-purplelight hover:duration-500">
