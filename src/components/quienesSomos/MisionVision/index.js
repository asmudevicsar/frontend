      ...
      <div className="sm:max-w-4xl m-auto gap-6 columns-1 grid grid-cols-1  lg:grid-cols-2  ">
        <div className="bg-white rounded-3xl border-2 border-[#9D9A9B] cursor-pointer py-10">
          ...
          <div className="pt-7 px-2">
            ...
            <p className="text-base text-[#606060] m-auto text-center leading-6 px-4  break-words">{mision}</p>
          </div>
        </div>
        <div className="bg-white rounded-3xl border-2 border-[#9D9A9B] cursor-pointer py-10">
          ...
          <div className="pt-7 px-2">
            ...
            <p className="text-base text-[#606060] m-auto text-center leading-6 px-4  break-words">{vision}</p>
          </div>
        </div>
      </div>
    </div>
